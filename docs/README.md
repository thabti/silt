...
| Doc | What it covers |
|---|---|
| [architecture.md](architecture.md) | How the pieces fit: catalog → scanner → index → cleaner, and why it is shaped that way |
| [safety.md](safety.md) | The three-gate safety model, the exact guard rules, and what is permanently off-limits |
| [catalog.md](catalog.md) | Every one of the 123 known locations — generated from the source, never hand-edited |
